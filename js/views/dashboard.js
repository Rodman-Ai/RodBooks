...
import { el, fmtMoney, fmtMoneyShort, fmtDate, monthKey, monthLabel, netFee, dealStatus, serviceMeta, initials } from "../utils.js";
...
export default function dashboard() {
  ...
  const render = () => {
    ...
    // ---- Top brands table (drill into brand page) ----
      ...
      el("div", { class: "table-scroll" },
        (function () {
          ...
          brandSorted.slice(0, 12).forEach(([brand, total]) => {
            ...
            const out = ds.filter((d) => !d.paid).reduce((s, d) => s + earned(d), 0);
